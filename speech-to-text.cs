...
namespace HomeAutomation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.ReadLine();
            // SmtpHost smtpHost = new SmtpHost("smtp.gmail.com", true, 465, "umapuja@gmail.com", "1011988uma");
            // var serverResponse = "";
            // MailManager mailManager = new MailManager(smtpHost);
            // mailManager.SendMail("umapuja@gmail.com", "umapuja@gmail.com", "test mail", "working", out serverResponse);
        }
